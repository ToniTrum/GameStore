...
def fetch_country_data():
    ...
    for country in countries:
        ...
        try:
            ...
            currency = CurrencyRate.objects.get(currency_code="USD")
            currency_symbol = "$"
        ...
        print(f"{'Created' if created else 'Updated'}: {numeric_code} -> {name_ru} {currency.currency_code} {currency_symbol}")
