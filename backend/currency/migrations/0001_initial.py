    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(default=currency.models.CurrencyRate.get_source_currency, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='countries', to='currency.currencyrate')),
            ],
        ),
    ]
