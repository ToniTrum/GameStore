                ...
                <div className="requirement-container">
                            ...
                            {tabs.map((tab, index) => (
                                <li
                                    ...
                                    <div className="tab-label">
                                        <img className="tab-icon" src={`${API_URL}/${tab.icon}`} alt={tab.label} />
                                        <span>{tab.label}</span>
                                    </div>
                                    {selectedTab === index && (
                                        <motion.div
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div 
                            ...
                            >
                            <RequirementText text={tabs[selectedTab].minimum} title="Минимальные требования" />
                            <RequirementText text={tabs[selectedTab].recommended} title="Рекомендуемые требования" />
                        </motion.div>
                    </AnimatePresence>
                </div>
            </section>
